...
scaler = pickle.load(open("Models/scaler.pkl", 'rb'))  # Ensure this is the scaler
model = pickle.load(open("Models/model.pkl", 'rb'))  # Ensure this is the trained model
...
def Recommendations(gender, part_time_job, absence_days, extracurricular_activities,
    ...
    # Predict using the model (make sure this is your classifier)
